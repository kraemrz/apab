...
## Table of Contents
- [🏭 APAB Inspection App](#-apab-inspection-app)
  ...
  - [Getting Started](#getting-started)
    ...
    - [Local Development Setup](#local-development-setup)
      ...
      - [3. Build and run the Docker Compose setup:](#3-build-and-run-the-docker-compose-setup)
    - [Accessing the Application](#accessing-the-application)
  - [Database Management](#database-management)
  - [Deployment](#deployment)
    - [Docker Hub Push](#docker-hub-push)
    - [Cloud Deployment (e.g., Render)](#cloud-deployment-eg-render)
